...
- **Install & Update**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.28.1/docs/install-or-update-prompt.md`
- **Diagnostic Doctor**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.28.1/docs/diagnostic-prompt.md`
- **Rollback**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.28.1/docs/rollback-prompt.md`
