...
> **Raw Prompt URL**: `https://raw.githubusercontent.com/rabee-elkholy/android-agent-harness/v0.28.3/docs/install-or-update-prompt.md`  
> **Kit Repository**: `https://github.com/rabee-elkholy/android-agent-harness.git`
> **Kit version**: `v0.28.3` — **SHA-256**: `8c93a673a652021912342f8dbc53cd60a8a0cd5bea67cc61724a0a76acb290ad` (SHA-256 of every byte after this line; verify first — mismatch = STOP)
---
